...
@Slf4j
@Singleton
public class DefaultSessionConfig implements SessionProvider {
        private final JsonObject sessionJsonObject;

        @Inject
        public DefaultSessionConfig(ApplicationConfig applicationConfig) {
        ...
        public SessionHandler getSessionHandler() {
                ...
                SessionStore sessionStore = SessionStore.create(VertxSingletonHolder.vertx());
